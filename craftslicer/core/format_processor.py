...
def vertex_color_to_voxel_color(voxels: np.ndarray, gl_model: GlModel):
    ...
    np.save("C:\\Users\\xia_t\\Desktop\\Main Folder\\CraftSlicer\\demo\\voxels.npy", voxels)
    np.save("C:\\Users\\xia_t\\Desktop\\Main Folder\\CraftSlicer\\demo\\voxel_color.npy", voxel_color)
